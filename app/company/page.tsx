            ...
            <PanelWrapper variant="light">
              ...
              <div className="grid gap-4 text-left md:grid-cols-2">
                <div>
                  ...
                  <p className="text-sm text-gray-600">admin@v2u.us</p>
                </div>
                <div>
                  <h3 className="font-semibold">Support</h3>
                  <p className="text-sm text-gray-600">support@v2u.us</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">9200 E Mineral Avenue, Flr 100<br />Centennial, CO 80112</p>
                </div>
              </div>
            </PanelWrapper>
          </div>
