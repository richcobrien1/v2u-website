          ...
          <div className="mt-6 flex gap-6">
            ...
            <div className="w-2/3 rounded-xl p-4 shadow-lg" style={{ backgroundColor: 'var(--panel-bg)', color: 'var(--panel-fg)' }}>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a href="/admin/send-digest" className="inline-block bg-blue-600 hover:bg-blue-700 text-white text-center px-4 py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-md">📧 Weekly Digest</a>
                <a href="/admin/email-template" className="inline-block bg-teal-600 hover:bg-teal-700 text-white text-center px-4 py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-md">Email Template</a>
