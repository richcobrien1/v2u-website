        ...
        <div className="max-w-4xl mx-auto">
          <div className="rounded-xl p-6 shadow-lg" style={{ backgroundColor: 'var(--panel-bg)', color: 'var(--panel-fg)' }}>
            ...
            <div className="mb-4 flex gap-2">
              <input value={newEmail} onChange={(e) => setNewEmail(e.target.value)} className="p-2 border border-gray-300 dark:border-gray-600 rounded w-full " placeholder="email@example.com" />
                  ...
                  {subs.map(s => (
                    <tr key={s.email} className="border-t border-gray-300 dark:border-gray-600">
                      <td className="dark:text-gray-100">
                        {editing === s.email ? (
                          <input value={editValue} onChange={(e) => setEditValue(e.target.value)} className="p-1 border border-gray-300 dark:border-gray-600 rounded " />
                        ) : (
                          s.email
                        )}
                      </td>
