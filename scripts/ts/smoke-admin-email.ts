// Simple smoke test for the admin email-template API.
// Usage: ADMIN_ONBOARD_TOKEN=test-onboard-token BASE_URL=http://localhost:3000 tsx scripts/ts/smoke-admin-email.ts
